		...
		public class Leg
		{
			...
			public void Process()
			{
				...
				case Quality.Simple:
				{
					...
					Vector3 vector3 = Vector3.Cross(rhs: GetRaycastHit(grounding.root.right * grounding.footRadius * 0.5f).point - heelHit.point, lhs: raycastHit.point - heelHit.point).normalized;
