...
namespace UnityStandardAssets.Vehicles.Car
{
	...
	public class CarAIControl : MonoBehaviour
	{
		...
		private void FixedUpdate()
		{
			...
			float num2 = ((!(num < m_CarController.CurrentSpeed)) ? m_AccelSensitivity : m_BrakeSensitivity);
			...
			float steering = Mathf.Clamp(num4 * m_SteerSensitivity, -1f, 1f) * Mathf.Sign(m_CarController.CurrentSpeed);
