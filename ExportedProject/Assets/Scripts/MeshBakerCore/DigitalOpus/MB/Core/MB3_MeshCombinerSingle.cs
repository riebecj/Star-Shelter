...
namespace DigitalOpus.MB.Core
{
	...
	public class MB3_MeshCombinerSingle : MB3_MeshCombiner
	{
		...
		private sealed class _003C_003Ec__DisplayClass54_1
		{
			...
			{
				return o == CS_0024_003C_003E8__locals1._goToAdd[i].GetInstanceID();
			}
		}
		...
		private bool _validateTextureBakeResults()
		{
			...
			{
				Debug.LogError("Texture Bake Results has no result material. Try baking materials. Can't combine meshes.");
				return false;
			}
			return true;
		}
		...
		private bool _addToCombined(GameObject[] goToAdd, int[] goToDelete, bool disableRendererInSource)
		{
			...
			if (goToAdd == null)
			{
				_003C_003Ec__DisplayClass54_._goToAdd = empty;
			}
			else
			{
				_003C_003Ec__DisplayClass54_._goToAdd = (GameObject[])goToAdd.Clone();
			}
			...
			{
				Debug.LogError("The number of submeshes in the combined mesh was not equal to the number of result materials in the Texture Bake Result");
				return false;
			}
			...
			if (LOG_LEVEL >= MB2_LogLevel.debug)
			{
				MB2_Log.LogDebug("==== Calling _addToCombined objs adding:" + _003C_003Ec__DisplayClass54_._goToAdd.Length + " objs deleting:" + array.Length + " fixOutOfBounds:" + textureBakeResults.fixOutOfBoundsUVs.ToString() + " doMultiMaterial:" + textureBakeResults.doMultiMaterial.ToString() + " disableRenderersInSource:" + disableRendererInSource.ToString(), LOG_LEVEL);
			}
			...
			{
				MB_DynamicGameObject dgo;
				if (instance2Combined_MapTryGetValue(array[k], out dgo))
				{
					num2 += dgo.numVerts;
					num3 += dgo.numBlendShapes;
					if (renderType == MB_RenderType.skinnedMeshRenderer)
					{
						for (int l = 0; l < dgo.indexesOfBonesUsed.Length; l++)
						{
							if (array3[dgo.indexesOfBonesUsed[l]].Contains(dgo))
							{
								array3[dgo.indexesOfBonesUsed[l]].Remove(dgo);
								if (array3[dgo.indexesOfBonesUsed[l]].Count == 0)
								{
									hashSet.Add(dgo.indexesOfBonesUsed[l]);
								}
							}
						}
					}
			...
			{
				dictionary2.Add(bones[n], n);
			}
			_003C_003Ec__DisplayClass54_1 _003C_003Ec__DisplayClass54_2 = new _003C_003Ec__DisplayClass54_1();
			_003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1 = _003C_003Ec__DisplayClass54_;
			_003C_003Ec__DisplayClass54_2.i = 0;
			while (_003C_003Ec__DisplayClass54_2.i < _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd.Length)
			{
				if (!instance2Combined_MapContainsKey(_003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i].GetInstanceID()) || Array.FindIndex(array, _003C_003Ec__DisplayClass54_2._003C_addToCombined_003Eb__0) != -1)
				{
					MB_DynamicGameObject mB_DynamicGameObject = new MB_DynamicGameObject();
					GameObject gameObject = _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i];
					...
					if (gOMaterials == null)
					{
						...
						_003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i] = null;
						return false;
					}
					...
					{
						if (!material2AtlasRectangleMapper.TryMapMaterialToUVRect(gOMaterials[num6], mesh, num6, meshChannelsCache, dictionary, out array5[num6], out array6[num6], out array7[num6], ref errorMsg, LOG_LEVEL))
						{
					...
					if (_003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i] != null)
					{
						list.Add(mB_DynamicGameObject);
						mB_DynamicGameObject.name = string.Format("{0} {1}", _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i].ToString(), _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i].GetInstanceID());
						mB_DynamicGameObject.instanceID = _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i].GetInstanceID();
						...
						{
							array4[mB_DynamicGameObject.targetSubmeshIdxs[num7]] += mB_DynamicGameObject._submeshTris[num7].Length;
						}
				...
				else
				{
					if (LOG_LEVEL >= MB2_LogLevel.warn)
					{
						Debug.LogWarning("Object " + _003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i].name + " has already been added");
					}
					_003C_003Ec__DisplayClass54_2.CS_0024_003C_003E8__locals1._goToAdd[_003C_003Ec__DisplayClass54_2.i] = null;
				}
				_003C_003Ec__DisplayClass54_2.i++;
			}
			for (int num8 = 0; num8 < _003C_003Ec__DisplayClass54_._goToAdd.Length; num8++)
			{
				if (_003C_003Ec__DisplayClass54_._goToAdd[num8] != null && disableRendererInSource)
				{
					MB_Utility.DisableRendererInSource(_003C_003Ec__DisplayClass54_._goToAdd[num8]);
					if (LOG_LEVEL == MB2_LogLevel.trace)
					{
						Debug.Log("Disabling renderer on " + _003C_003Ec__DisplayClass54_._goToAdd[num8].name + " id=" + _003C_003Ec__DisplayClass54_._goToAdd[num8].GetInstanceID());
					}
				}
			}
			...
			if (LOG_LEVEL >= MB2_LogLevel.debug)
			{
				Debug.Log("Verts adding:" + num4 + " deleting:" + num2 + " submeshes:" + array8.Length + " bones:" + num10 + " blendShapes:" + num11);
			}
			for (int num12 = 0; num12 < array8.Length; num12++)
			{
				...
				if (LOG_LEVEL >= MB2_LogLevel.debug)
				{
					MB2_Log.LogDebug("    submesh :" + num12 + " already contains:" + submeshTris[num12].Length + " tris to be Added:" + array4[num12] + " tris to be Deleted:" + array2[num12]);
				}
			}
			if (num9 > 65534)
			{
			...
			for (int num18 = 0; num18 < mbDynamicObjectsInCombinedMesh.Count; num18++)
			{
				...
				if (!mB_DynamicGameObject2._beingDeleted)
				{
					...
					if (_doBlendShapes)
					{
						Array.Copy(blendShapes, mB_DynamicGameObject2.blendShapeIdx, array9, num16, mB_DynamicGameObject2.numBlendShapes);
					}
					if (renderType == MB_RenderType.skinnedMeshRenderer)
					{
						Array.Copy(boneWeights, mB_DynamicGameObject2.vertIdx, array10, num15, mB_DynamicGameObject2.numVerts);
					}
					for (int num19 = 0; num19 < num; num19++)
					{
						...
						if (LOG_LEVEL >= MB2_LogLevel.debug)
						{
							MB2_Log.LogDebug("    Adjusting submesh triangles submesh:" + num19 + " startIdx:" + num20 + " num:" + num21 + " nsubmeshTris:" + array13.Length + " targSubmeshTidx:" + array14.Length, LOG_LEVEL);
						}
			...
			for (int num27 = 0; num27 < list.Count; num27++)
			{
				...
				GameObject gameObject2 = _003C_003Ec__DisplayClass54_._goToAdd[num27];
				int num28 = num15;
				int index = num16;
				...
				float value = (matrix4x[1, 3] = num30);
				matrix4x[0, 3] = value;
				...
				if (renderType == MB_RenderType.skinnedMeshRenderer)
				{
					...
					_AddBonesToNewBonesArrayAndAdjustBWIndexes(mB_DynamicGameObject3, renderer2, num28, array12, array10, meshChannelsCache);
				}
				for (int num34 = 0; num34 < array14.Length; num34++)
				{
					mB_DynamicGameObject3.submeshTriIdxs[num34] = array14[num34];
				}
				for (int num35 = 0; num35 < mB_DynamicGameObject3._submeshTris.Length; num35++)
				{
					int[] array18 = mB_DynamicGameObject3._submeshTris[num35];
					...
					{
						for (int num37 = 0; num37 < array18.Length; num37 += 3)
						{
							int num38 = array18[num37];
							array18[num37] = array18[num37 + 1];
							array18[num37 + 1] = num38;
						}
					}
					int num39 = mB_DynamicGameObject3.targetSubmeshIdxs[num35];
					array18.CopyTo(submeshTris[num39], array14[num39]);
					mB_DynamicGameObject3.submeshNumTris[num39] += array18.Length;
					array14[num39] += array18.Length;
				}
				...
				{
					mB_DynamicGameObject3._submeshTris[num40] = null;
				}
