...
public class FractalNoiseCloud
{
	...
	private PerlinCloud m_Noise;

	private float m_Octaves;

	public FractalNoiseCloud(float inH, float inLacunarity, float inOctaves)
		: this(inH, inLacunarity, inOctaves, null)
	{
	}

	public FractalNoiseCloud(float inH, float inLacunarity, float inOctaves, PerlinCloud noise)
	{
