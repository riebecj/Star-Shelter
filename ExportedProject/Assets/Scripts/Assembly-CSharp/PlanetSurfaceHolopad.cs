...
public class PlanetSurfaceHolopad : MonoBehaviour
{
	public GameObject player;

	public Animator target;

	private GameObject planetWarpAnimation;
	...
	public void StartWarping()
	{
		...
		player.transform.position = targetHolodeck.transform.position + new Vector3(0f, 1f, 0f);
		lerping2 = false;
		shouldLerp2 = false;
	}
	...
	private void Start()
	{
		...
		planetWarpAnimation = GameObject.FindWithTag("PlanetWarpAnim");
		RenderSettings.skybox = skyOne;
		rigidBody = player.GetComponent<Rigidbody>();
		target = planetWarpAnimation.GetComponent<Animator>();
	}
