...
namespace Valve.VR.InteractionSystem
{
	public static class Util
	{
		...
		public static Transform FindChild(Transform parent, string name)
		{
			...
			try
			{
				while (enumerator.MoveNext())
				{
					...
					Transform transform = FindChild(parent2, name);
					if (transform != null)
					{
						return transform;
					}
		...
		public static T Median<T>(this IEnumerable<T> source)
		{
			...
			return source.OrderBy(_003CMedian_00601_003Em__0).ElementAt(num / 2);
		}
		...
		[CompilerGenerated]
		private static T _003CMedian_00601_003Em__0<T>(T x)
		{
			return x;
		}
	}
