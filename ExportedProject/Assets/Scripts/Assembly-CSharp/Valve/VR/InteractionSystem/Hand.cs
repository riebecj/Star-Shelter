...
namespace Valve.VR.InteractionSystem
{
	public class Hand : MonoBehaviour
	{
		...
		[CompilerGenerated]
		private sealed class _003CDetachObject_003Ec__AnonStorey1
		{
			internal GameObject objectToDetach;

			internal bool _003C_003Em__0(AttachedObject l)
			{
				return l.attachedObject == objectToDetach;
			}
		}

		[CompilerGenerated]
		private sealed class _003CUpdateHovering_003Ec__AnonStorey2
		{
			internal Interactable contacting;

			internal bool _003C_003Em__0(AttachedObject l)
			{
				return l.attachedObject == contacting.gameObject;
			}
		}
		...
		[CompilerGenerated]
		private static Predicate<AttachedObject> _003C_003Ef__am_0024cache0;
		...
		{
			_003CDetachObject_003Ec__AnonStorey1 _003CDetachObject_003Ec__AnonStorey = new _003CDetachObject_003Ec__AnonStorey1();
			_003CDetachObject_003Ec__AnonStorey.objectToDetach = objectToDetach;
			int num = attachedObjects.FindIndex(_003CDetachObject_003Ec__AnonStorey._003C_003Em__0);
			if (num != -1)
			{
				HandDebugLog("DetachObject " + _003CDetachObject_003Ec__AnonStorey.objectToDetach);
				...
				attachedObjects[num].attachedObject.SetActive(true);
		...
		{
			List<AttachedObject> list = attachedObjects;
			if (_003C_003Ef__am_0024cache0 == null)
			{
				_003C_003Ef__am_0024cache0 = _003CCleanUpAttachedObjectStack_003Em__0;
			}
		...
		private void UpdateHovering()
		{
			...
			{
				_003CUpdateHovering_003Ec__AnonStorey2 _003CUpdateHovering_003Ec__AnonStorey = new _003CUpdateHovering_003Ec__AnonStorey2();
				if (collider == null)
				{
					continue;
				}
				_003CUpdateHovering_003Ec__AnonStorey.contacting = collider.GetComponentInParent<Interactable>();
				if (_003CUpdateHovering_003Ec__AnonStorey.contacting == null)
				{
					continue;
				}
				IgnoreHovering component = collider.GetComponent<IgnoreHovering>();
				if ((!(component != null) || (!(component.onlyIgnoreHand == null) && !(component.onlyIgnoreHand == this))) && attachedObjects.FindIndex(_003CUpdateHovering_003Ec__AnonStorey._003C_003Em__0) == -1 && (!otherHand || !(otherHand.hoveringInteractable == _003CUpdateHovering_003Ec__AnonStorey.contacting)))
				{
					float num6 = Vector3.Distance(_003CUpdateHovering_003Ec__AnonStorey.contacting.transform.position, hoverSphereTransform.position);
					if (num6 < num)
					{
						num = num6;
						interactable = _003CUpdateHovering_003Ec__AnonStorey.contacting;
					}
					num5++;
				}
			}
		...
		private void UpdateNoSteamVRFallback()
		{
			...
			RaycastHit hitInfo;
			if (Physics.Raycast(ray, out hitInfo, noSteamVRFallbackMaxDistanceNoItem))
			{
		...
		private void InitController(int index)
		{
			if (controller == null)
			{
				...
				controllerObject.layer = base.gameObject.layer;
				controllerObject.tag = base.gameObject.tag;
				AttachObject(controllerObject, AttachmentFlags.SnapOnAttach | AttachmentFlags.DetachOthers | AttachmentFlags.DetachFromOtherHand | AttachmentFlags.ParentToHand, string.Empty);
		...
		[CompilerGenerated]
		private static bool _003CCleanUpAttachedObjectStack_003Em__0(AttachedObject l)
		{
			return l.attachedObject == null;
		}
	}
}
