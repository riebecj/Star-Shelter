...
public class HealthContainer : MonoBehaviour
{
	...
	public IEnumerator Drain()
	{
		...
		while (heathValue > 0f)
		{
			...
			{
				heathValue -= refreshRate * drainSpeed;
				SuitManager.instance.health += refreshRate * drainSpeed;
				float z = heathValue / startValue;
		...
		if (heathValue <= 0f && IntroManager.instance == null)
		{
			AddComponent();
			OnBreak();
		}
