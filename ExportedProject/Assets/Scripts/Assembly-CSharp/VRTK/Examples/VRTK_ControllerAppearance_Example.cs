...
namespace VRTK.Examples
{
	public class VRTK_ControllerAppearance_Example : MonoBehaviour
	{
		...
		private void PulseTrigger()
		{
			...
			currentPulseColor = ((!(currentPulseColor == pulseColor)) ? pulseColor : highlightColor);
		}

		private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
		{
			tooltips.ToggleTips(true, VRTK_ControllerTooltips.TooltipButtons.TriggerTooltip);
			highligher.HighlightElement(SDK_BaseController.ControllerElements.Trigger, highlightColor, (!pulseTriggerHighlightColor) ? highlightTimer : pulseTimer);
