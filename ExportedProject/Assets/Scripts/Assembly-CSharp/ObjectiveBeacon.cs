...
public class ObjectiveBeacon : Objective
{
	public Text[] subObjectives;

	public GameObject[] checkMarks;

	public static ObjectiveBeacon instance;
	...
	private void Start()
	{
		if (PreviewLabs.PlayerPrefs.GetBool("ObjectiveBeacon"))
		{
			complete = true;
			return;
		}
	...
	public void OnObjectiveComplete()
	{
		...
		{
			complete = true;
			PreviewLabs.PlayerPrefs.SetBool("ObjectiveBeacon", true);
